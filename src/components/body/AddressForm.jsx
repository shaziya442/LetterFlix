...
export default function AddressForm() {
  ...
  return (
    <div className="px-5 lg:mt-24 md:py-24 h-[100%] box-border bg-blue-900 sm:h-[100%]">
      ...
      <p className="font-[Lora] text-[20px] mx-[181px] mx-auto pt-8 text-white text-center space-y-[30px] sm:ml-[0px] sm:mr-[0px] sm:text-[18px] mx-auto max-w-[60%] sm:max-w-[100%]">
      ...
      <div
        className="flex flex-wrap items-center justify-center pb-[70px] max-w-[768px] text-center mx-auto font-[Lora] mr-7 ml-[300px] text-grey-400 space-y-[30px] sm:mx-[0px]"
